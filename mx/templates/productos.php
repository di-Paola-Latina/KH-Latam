...
<div class="bg-white max-90">
  ...
  <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 no-gutters justify-content-center mx-md-5 px-md-5 px-2 mx-0">
    <?php
    for ($i = 0; $i < $contar_productos; $i++) {
    ?>
      <div class="col mb-4 p-md-3 p-md-1">
        <div class="card border-0 bg-white h-100">
          <img src="img/mx/home/<?php echo $productos[$i]['img']; ?>" class="card-img-top w-75 mx-auto" alt="...">
          <div class="card-body">
